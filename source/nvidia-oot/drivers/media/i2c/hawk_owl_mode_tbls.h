...
static struct index_reg_8 ar0234_Owl_SingleLink_Dser_Ser[] = {
	...
	{DES_ADDR, 0x00F0, 0x51},// Link A ID 1 to pipe 0 // Link B ID 1 to pipe 1
	{DES_ADDR, 0x00F1, 0xD9}, // Link c ID 1 to pipe 2	// Link D ID 1 to pipe 3
#ifdef CSI_4X2
	...
	{DES_ADDR, 0x09CA, 0x40},
#else //CSI_2X4
	{DES_ADDR, 0x08A0, 0x04},// CSI output is 2x4
	{DES_ADDR, 0x08A3, 0xe4},// phy1-D1 -> csi-D3, phy1-D0 -> csi-D2, phy0-D1 -> csi-D1, phy0-D0 -> csi-D0
	{DES_ADDR, 0x08A4, 0xe4},// phy3-D1 -> csi-D3, phy3-D0 -> csi-D2, phy2-D1 -> csi-D1, phy2-D0 -> csi-D0

	{DES_ADDR, 0x094A, 0xE0},// 4 lanes and cphy mode on controller 1 (controller 0 is unused)
	{DES_ADDR, 0x098A, 0xE0},// 4 lanes and cphy mode on controller 2 (controller 3 is unused)
#endif
	{DES_ADDR, 0x1D00, 0xF4},
	{DES_ADDR, 0x1E00, 0xF4},
	...
	// Pipe 0
	{DES_ADDR, 0x090B, 0x07}, // Enable 3 mappings  Pipe 0//video2
	{DES_ADDR, 0x092D, 0xAA},// All mappings to controller 2 (port B)
	{DES_ADDR, 0x090D, 0x2B}, // Input RAW10, VC0
	{DES_ADDR, 0x090E, 0x2B}, // Output RAW10, VC0
	{DES_ADDR, 0x090F, 0x00}, // Input FS, VC0
	{DES_ADDR, 0x0910, 0x00},// Output FS, VC0
...
static struct index_reg_8 ar0234_Owl_DualLink_Dser_Ser[] = {
	...
	// Pipe 1
	{DES_ADDR, 0x094B, 0x07}, // Enable 3 mappings  Pipe 1  //video3
	{DES_ADDR, 0x096D, 0xAA},// All mappings to controller 2 (port B)
	{DES_ADDR, 0x094D, 0x2B}, // Input RAW10, VC0
	{DES_ADDR, 0x094E, 0x6B}, // Output RAW10, VC1
	{DES_ADDR, 0x094F, 0x00}, // Input FS, VC0
	{DES_ADDR, 0x0950, 0x40},// Output FS, VC1
...
static struct index_reg_8 ar0234_Owl_TripleLink_Dser_Ser[] = {
	...
	// Pipe 2
	{DES_ADDR, 0x098B, 0x07}, // Enable 3 mappings Pipe 2  //video1
	{DES_ADDR, 0x09AD, 0xAA},// All mappings to controller 2 (port B)
	{DES_ADDR, 0x098D, 0x2B}, // Input RAW10, VC0
...
static struct index_reg_8 ar0234_Owl_QuadLink_Dser_Ser[] = {
	...
	// Pipe 3
	{DES_ADDR, 0x09CB, 0x07}, // Enable 3 mappings  Pipe 3  //video0
	{DES_ADDR, 0x09ED, 0xAA},// All mappings to controller 2 (port B)
	{DES_ADDR, 0x09CD, 0x2B}, // Input RAW10, VC0
