...
static struct index_reg_8 i2c_address_trans_hawk_Single_ser[] = {
	{DES_ADDR, 0x0006, 0x11},
	{SER_ADDR, 0x0000, 0x94},
	{0x00, AR0234_TABLE_END, 0x00}
};
...
static struct index_reg_8 i2c_address_trans_hawk_Dual_ser[] = {
	{DES_ADDR, 0x0006, 0x11},
	{SER_ADDR, 0x0000, 0x94},
	{DES_ADDR, 0x0006, 0x33},
	{SER_ADDR, 0x0000, 0x96},
	{0x00, AR0234_TABLE_END, 0x00}
};
...
static struct index_reg_8 i2c_address_trans_hawk_Triple_ser[] = {
	...
	{DES_ADDR, 0x0006, 0x33},
	{SER_ADDR, 0x0000, 0x96},
	{DES_ADDR, 0x0006, 0x77},
	{SER_ADDR, 0x0000, 0x98},
	{0x00, AR0234_TABLE_END, 0x00}
};
...
static struct index_reg_8 i2c_address_trans_hawk_Quad_ser[] = {
	...
	{DES_ADDR, 0x0006, 0x77},
	{SER_ADDR, 0x0000, 0x98},
	{DES_ADDR, 0x0006, 0xff},
	{SER_ADDR, 0x0000, 0x9a},
	{0x00, AR0234_TABLE_END, 0x00}
};
...
static struct index_reg_8 ar0234_Hawk_SingleLink_Dser_Ser[] = {
	{DES_ADDR, 0x1458, 0x28},
	{DES_ADDR, 0x1459, 0x68},
	{DES_ADDR, 0x1558, 0x28},
	{DES_ADDR, 0x1559, 0x68},
	{DES_ADDR, 0x1658, 0x28},
	{DES_ADDR, 0x1659, 0x68},
	{DES_ADDR, 0x1758, 0x28},
	{DES_ADDR, 0x1759, 0x68},

	{DES_ADDR, 0x0018, 0x0F}, // Oneshot reset
	{DES_ADDR, 0x0006, 0xFF}, // Enable links A, B, C & D
	...
	{DES_ADDR, 0x00F0, 0x10}, // Link A ID 0 to pipe 0 // Link A ID 1 to pipe 1
	{DES_ADDR, 0x00F1, 0x54}, // Link B ID 0 to pipe 2 // Link B ID 1 to pipe 3
	{DES_ADDR, 0x00F2, 0x98},
	{DES_ADDR, 0x00F3, 0Xdc},

	{DES_ADDR, 0x08A0, 0x01}, // CSI output is 2x4
	{DES_ADDR, 0x08A3, 0x44}, // Default 4x2 lane mapping
	{DES_ADDR, 0x08A4, 0x44}, // Default 4x2 lane mapping

	{DES_ADDR, 0x090A, 0x40},
	{DES_ADDR, 0x094A, 0x40}, // 2 lanes on port D
	{DES_ADDR, 0x098A, 0x40}, // 2 lanes on port E
	{DES_ADDR, 0x09CA, 0x40},

	{DES_ADDR, 0x1D00, 0xF4},
	{DES_ADDR, 0x1E00, 0xF4},

	{DES_ADDR, 0x0415, 0x39},
	{DES_ADDR, 0x0418, 0x39},// 2500Mbps/lane on port D
	{DES_ADDR, 0x041B, 0x39},// 2500Mbps/lane on port E
	{DES_ADDR, 0x041E, 0x39},

	{DES_ADDR, 0x1D00, 0xF5},
	{DES_ADDR, 0x1E00, 0xF5},

	/* Set Video pipe to MIPI controller */
	/* For HAWK1 */
	{DES_ADDR, 0x090B, 0x07}, // Enable 3 mappings  Pipe 0//video2
	{DES_ADDR, 0x092D, 0x00}, // All mappings to controller 0 (port A)
	{DES_ADDR, 0x090D, 0x2B}, // Input RAW10, VC0
	{DES_ADDR, 0x090E, 0x2B}, // Output RAW10, VC0
	{DES_ADDR, 0x090F, 0x00}, // Input FS, VC0
	{DES_ADDR, 0x0910, 0x00}, // Output FS, VC0
	{DES_ADDR, 0x0911, 0x01}, // Input FE, VC0
	{DES_ADDR, 0x0912, 0x01}, // Output FE, VC0

	{DES_ADDR, 0x094B, 0x07}, // Enable 3 mappings  Pipe 1  //video3
	{DES_ADDR, 0x096D, 0x00}, // All mappings to controller 0 (port A)
	{DES_ADDR, 0x094D, 0x2B}, // Input RAW10, VC0
	{DES_ADDR, 0x094E, 0x6B}, // Output RAW10, VC1
	{DES_ADDR, 0x094F, 0x00}, // Input FS, VC0
	{DES_ADDR, 0x0950, 0x40}, // Output FS, VC1
	{DES_ADDR, 0x0951, 0x01}, // Input FE, VC0
	{DES_ADDR, 0x0952, 0x41}, // Output FE, VC1

	{DES_ADDR, 0x08A2, 0xF0},
	...
	{DES_ADDR, 0x0310, 0x84}, // max96712 MFF5---ACCEL1 interrupt
	{DES_ADDR, 0x0311, 0xb1}, // ID = 0b'10001
	{DES_ADDR, 0x0312, 0x51}, // ID = 0b'10001

	{0x94, 0x02c4, 0x83}, // max9295D MFP2-- gyro interrup
	{0x94, 0x02c5, 0x33}, //ID = 0b'10003
	{0x94, 0x02c6, 0x53}, //ID = 0b'10003
	{DES_ADDR, 0x0316, 0x84}, // max96712 MTF7---gyro1 interrupt
	{DES_ADDR, 0x0317, 0xb3}, // ID = 0b'10003
	{DES_ADDR, 0x0318, 0x53}, // ID = 0b'10003
...
static struct index_reg_8 ar0234_Hawk_DualLink_Dser_Ser[] = {
	...
	{DES_ADDR, 0x00F4, 0xff}, // Enable pipe 0
	...
	/* For HAWK2 */
	{DES_ADDR, 0x098B, 0x07}, // Enable 3 mappings Pipe 2  //video1
	{DES_ADDR, 0x09AD, 0x15}, // All mappings to controller 1 (port A)
	{DES_ADDR, 0x098D, 0x2B}, // Input RAW10, VC0
	{DES_ADDR, 0x098E, 0x2B}, // Output RAW10, VC0
	{DES_ADDR, 0x098F, 0x00}, // Input FS, VC0
	{DES_ADDR, 0x0990, 0x00},// Output FS, VC0
	{DES_ADDR, 0x0991, 0x01}, // Input FE, VC0
	{DES_ADDR, 0x0992, 0x01}, // Output FE, VC0

	{DES_ADDR, 0x09CB, 0x07}, // Enable 3 mappings  Pipe 3  //video0
	{DES_ADDR, 0x09ED, 0x15}, // All mappings to controller 1 (port A)
	{DES_ADDR, 0x09CD, 0x2B}, // Input RAW10, VC0
	{DES_ADDR, 0x09CE, 0x6B}, // Output RAW10, VC1
	{DES_ADDR, 0x09CF, 0x00}, // Input FS, VC0
	{DES_ADDR, 0x09D0, 0x40},// Output FS, VC1
	{DES_ADDR, 0x09D1, 0x01}, // Input FE, VC0
	{DES_ADDR, 0x09D2, 0x41}, // Output FE, VC1
...
static struct index_reg_8 ar0234_Hawk_TripleLink_Dser_Ser[] = {
	...
	{DES_ADDR, 0x00F4, 0x3f}, // Enable video pipe 0,1,2,3,4,5
	...
	/* For HAWK3 */
	{DES_ADDR, 0x0A0B, 0x07}, // Enable 3 mappings Pipe 4 i.e RAW10, FS & FE mappings.
	{DES_ADDR, 0x0A2D, 0x2A}, // Map all 3 mappings to controller 2
	{DES_ADDR, 0x0A0D, 0x2B}, // Input RAW10 on VC0
	{DES_ADDR, 0x0A0E, 0x2B}, // Output RAW10 on VC0
	{DES_ADDR, 0x0A0F, 0x00}, // Input FS on VC0
	{DES_ADDR, 0x0A10, 0x00}, // Output FS on VC0
	{DES_ADDR, 0x0A11, 0x01}, // Input FE on VC0
	{DES_ADDR, 0x0A12, 0x01}, // Output FE on VC0

	{DES_ADDR, 0x0A4B, 0x07}, // Enable 3 mappings Pipe 5 i.e RAW10, FS & FE mappings.
	{DES_ADDR, 0x0A6D, 0x2A}, // Map all 3 mappings to controller 2
	{DES_ADDR, 0x0A4D, 0x2B}, // Input RAW10 on VC0
	{DES_ADDR, 0x0A4E, 0x6B}, // Output RAW10 on VC1
	{DES_ADDR, 0x0A4F, 0x00}, // Input FS on VC0
	{DES_ADDR, 0x0A50, 0x40}, // Output FS on VC1
	{DES_ADDR, 0x0A51, 0x01}, // Input FE on VC0
	{DES_ADDR, 0x0A52, 0x41}, // Output FE on VC1
...
static struct index_reg_8 ar0234_Hawk_QuadLink_Dser_Ser[] = {
	...
	/* For HAWK4 */
	{DES_ADDR, 0x0A8B, 0x07}, // Enable 3 mappings Pipe 6 i.e RAW10, FS & FE mappings.
	{DES_ADDR, 0x0AAD, 0x3F}, // Map all 3 mappings to controller 3
	{DES_ADDR, 0x0A8D, 0x2B}, // Input RAW10 on VC0
	{DES_ADDR, 0x0A8E, 0x2B}, // Output RAW10 on VC0
	{DES_ADDR, 0x0A8F, 0x00}, // Input FS on VC0
	{DES_ADDR, 0x0A90, 0x00}, // Output FS on VC0
	{DES_ADDR, 0x0A91, 0x01}, // Input FE on VC0
	{DES_ADDR, 0x0A92, 0x01}, // Output FE on VC0

	{DES_ADDR, 0x0ACB, 0x07}, // Enable 3 mappings Pipe 7 i.e RAW10, FS & FE mappings.
	{DES_ADDR, 0x0AED, 0x3F}, // Map all 3 mappings to controller 3
	{DES_ADDR, 0x0ACD, 0x2B}, // Input RAW10 on VC0
	{DES_ADDR, 0x0ACE, 0x6B}, // Output RAW10 on VC1
	{DES_ADDR, 0x0ACF, 0x00}, // Input FS on VC0
	{DES_ADDR, 0x0AD0, 0x40}, // Output FS on VC1
	{DES_ADDR, 0x0AD1, 0x01}, // Input FE on VC0
	{DES_ADDR, 0x0AD2, 0x41}, // Output FE on VC1
...
static struct index_reg_8 Hawk_SingleLink_Dser_InFsync[] = {
	...
	{DES_ADDR, 0x04AF, 0xC0}, // AUTO_FS_LINKS = 0, FS_USE_XTAL = 1, FS_LINK_[3:0] = 0
	{DES_ADDR, 0x04A0, 0x00}, // Manual frame sync, no pin output
	{DES_ADDR, 0x04A2, 0x00}, // Turn off auto master link selection
	{DES_ADDR, 0x04AA, 0x00}, // OVLP window = 0
	{DES_ADDR, 0x04AB, 0x00},
	{DES_ADDR, 0x04A5, 0x35}, // 30Hz FSYNC
	{DES_ADDR, 0x04A6, 0xB7},
	{DES_ADDR, 0x04A7, 0x0C},
	...
	{DES_ADDR, 0x04B1, 0x40}, // FSYNC TX ID is 8
...
static struct index_reg_8 Hawk_SingleLink_Dser_ExFsync[] = {
	...
	{DES_ADDR, 0x04A0, 0x08},
	{DES_ADDR, 0x04AF, 0x9F},
	/* Config MAX96712/722 MFP2 to receive external FSYNC signal for each link */
	{DES_ADDR, 0x0306, 0x83},
	{DES_ADDR, 0x033D, 0x22},
	{DES_ADDR, 0x0374, 0x22},
	{DES_ADDR, 0x03AA, 0x22},
...
static struct index_reg_8 ar0234_Owl_SingleLink_Dser_Ser[] = {
	...
	{0x94, 0x0308, 0x62},
	{0x94, 0x0316, 0x6b},
	{0x94, 0x0002, 0x23},// Enable pipe Y

	{DES_ADDR, 0x00F4, 0x0f},// Enable pipe 0 -3
	{DES_ADDR, 0x00F0, 0x51},// Link A pipe Y to pipe 0 // Link B pipe Y to pipe 1
	{DES_ADDR, 0x00F1, 0xD9},// Link c pipe Y to pipe 2	// Link D pipe Y to pipe 3

	{DES_ADDR, 0x08A0, 0x01},// CSI output is 4x2
	{DES_ADDR, 0x08A3, 0x44},// Default 4x2 lane mapping
	{DES_ADDR, 0x08A4, 0x44},// Default 4x2 lane mapping
	...
	{DES_ADDR, 0x0415, 0x39},
	{DES_ADDR, 0x0418, 0x39},// 1500Mbps/lane on port D
	{DES_ADDR, 0x041B, 0x39},// 1500Mbps/lane on port E
	{DES_ADDR, 0x041E, 0x39},
	...
	// Pipe 0
	{DES_ADDR, 0x090B, 0x07}, // Enable 3 mappings  Pipe 0//video2
	{DES_ADDR, 0x092D, 0x00},// All mappings to controller 2 (port B)
	{DES_ADDR, 0x090D, 0x2B}, // Input RAW10, VC0
	{DES_ADDR, 0x090E, 0x2B}, // Output RAW10, VC0
	{DES_ADDR, 0x090F, 0x00}, // Input FS, VC0
	{DES_ADDR, 0x0910, 0x00},// Output FS, VC0
...
static struct index_reg_8 ar0234_Owl_DualLink_Dser_Ser[] = {
	...
	{0x96, 0x0308, 0x62},
	{0x96, 0x0316, 0x6b},
	{0x96, 0x0002, 0x23},// Enable pipe Y
	...
	// Pipe 1
	{DES_ADDR, 0x094B, 0x07}, // Enable 3 mappings  Pipe 1  //video3
	{DES_ADDR, 0x096D, 0x00},// All mappings to controller 2 (port B)
	{DES_ADDR, 0x094D, 0x2B}, // Input RAW10, VC0
	{DES_ADDR, 0x094E, 0x6B}, // Output RAW10, VC1
	{DES_ADDR, 0x094F, 0x00}, // Input FS, VC0
	{DES_ADDR, 0x0950, 0x40},// Output FS, VC1
...
static struct index_reg_8 ar0234_Owl_TripleLink_Dser_Ser[] = {
	...
	{0x98, 0x0308, 0x62},
	{0x98, 0x0316, 0x6b},
	{0x98, 0x0002, 0x23},// Enable pipe Y
	...
	// Pipe 2
	{DES_ADDR, 0x098B, 0x07}, // Enable 3 mappings Pipe 2  //video1
	{DES_ADDR, 0x09AD, 0x00},// All mappings to controller 2 (port B)
	{DES_ADDR, 0x098D, 0x2B}, // Input RAW10, VC0
	{DES_ADDR, 0x098E, 0xaB}, // Output RAW10, VC2
	{DES_ADDR, 0x098F, 0x00}, // Input FS, VC0
	{DES_ADDR, 0x0990, 0x80},// Output FS, VC2
	{DES_ADDR, 0x0991, 0x01}, // Input FE, VC0
	{DES_ADDR, 0x0992, 0x81}, // Output FE, VC2
...
static struct index_reg_8 ar0234_Owl_QuadLink_Dser_Ser[] = {
	...
	{0x9A, 0x0308, 0x62},
	{0x9A, 0x0316, 0x6b},
	{0x9A, 0x0002, 0x23},// Enable pipe Y
	...
	// Pipe 3
	{DES_ADDR, 0x09CB, 0x07}, // Enable 3 mappings  Pipe 3  //video0
	{DES_ADDR, 0x09ED, 0x00},// All mappings to controller 2 (port B)
	{DES_ADDR, 0x09CD, 0x2B}, // Input RAW10, VC0
	{DES_ADDR, 0x09CE, 0xEB}, // Output RAW10, VC3
	{DES_ADDR, 0x09CF, 0x00}, // Input FS, VC0
	{DES_ADDR, 0x09D0, 0xc0},// Output FS, VC3
	{DES_ADDR, 0x09D1, 0x01}, // Input FE, VC0
	{DES_ADDR, 0x09D2, 0xc1}, // Output FE, VC3
	{DES_ADDR, 0x08A2, 0xF0},
	...
	{0x96, 0x02be, 0x90}, // (GPIO0_A) Enable sensor power down pin. Put imager in ,Active mode
	{0x96, 0x02ca, 0x80}, // (GPIO4_A) Enable sensor power down pin.
	{0x96, 0x02cb, 0x60}, // (GPIO4_B) Enable sensor reset pin.
	{0x96, 0x03F1, 0x00},
...
static struct index_reg_8 ar0231_Dser[] = {
	{0x4E, 0x040B, 0x00}, // CSI output disabled
	{0x4E, 0x0006, 0xFF}, // LINKD/C/B/A, all set as GMSL2 and enabled
	{0x4E, 0x0003, 0xAA}, // Enable CC port0 on LinkA/B/C/D remote control channel
	
	// Mapping video pipe to GMSL link
	{0x4E, 0x00F0, 0x40}, // Select Video pipe0 <-> PHY A(GMSL) Pipe X | Select Video pipe1 <-> PHY B(GMSL) Pipe X
	{0x4E, 0x00F1, 0xC8}, // Select Video pipe2 <-> PHY C(GMSL) Pipe X | Select Video pipe3 <-> PHY D(GMSL) Pipe X
	{0x4E, 0x00F4, 0x0F}, // Enable pipe select and enable pipe 0~3
	
	{0x4E, 0x040B, 0x50}, // Pipe 0 BPP sofware-override to raw10
	{0x4E, 0x0411, 0x4A}, // Pipe 1 BPP and pipe 2 BPP high bits sofware-override to raw10
	{0x4E, 0x0412, 0x2A}, // Pipe 2 BPP low bits and pipe 3 BPP sofware-override to raw10
	{0x4E, 0x040E, 0xAB}, // Pipe 0 DT and pipe 1 DT high bits software-override to raw10	
	{0x4E, 0x040F, 0xAB}, // Pipe 1 DT low bits and pipe DT high bits software-override to raw10
	{0x4E, 0x0410, 0xAF}, // Pipe 2 DT low bits and pipe 3 DT software-override to raw10
	{0x4E, 0x040C, 0x10}, // Pipe 0 VC = 0 and pipe 1 VC = 1
	{0x4E, 0x040D, 0x32}, // Pipe 2 VC = 2 and pipe 3 VC = 3
	
	{0x4E, 0x0415, 0xFF}, // Enable Pipe 0 and pipe 1 software-override
	{0x4E, 0x0418, 0xFF}, // Enable Pipe 2 and pipe 3 software-override
	
	// Pipe to Controller Mapping Configuration
	{0x4E, 0x08CA, 0xAA}, // Mapping all pipes to controller 2
	
	// MIPI C-PHY Configuration
	{0x4E, 0x08A0, 0x04}, // MIPI PHY : 2x4 mode
	{0x4E, 0x098A, 0xF0}, // Select MIPI PHY2 4 data lane and C-PHY mode
	{0x4E, 0x09CA, 0x70}, // Select MIPI PHY3 2 data lane and C-PHY mode
	{0x4E, 0x08AD, 0x00}, // Set C-PHY t_t3_prebegin phase unit
	{0x4E, 0x08AE, 0x45}, // Set C-PHY t_t3_post unit
	{0x4E, 0x08A4, 0xE4}, // MAP PHY2 D0 -> D0, PHY2 D1 -> D1, PHY3 D0 -> D2, PHY3 D1 -> D3
	{0x4E, 0x0983, 0x07}, // Close auto deskew init (deskew is for DPHY only)
	{0x4E, 0x0984, 0x01}, // Close periodic deskew calibration
	{0x4E, 0x1E00, 0xF4}, // (config_soft_rst_n - PHY2): 0x0. No data for this reg
	{0x4E, 0x041B, 0x2f}, // Set MIPI PHY 2 C-PHY data rate = 3.42Gbps/trio (Default)
	{0x4E, 0x1E00, 0xF5}, // (config_soft_rst_n - PHY2): 0x1. No data for this reg
	{0x4E, 0x08A2, 0xC4}, // Enable MIPI PHY2,3, and put PYH0,1 in standby mode
	{0x4E, 0x040B, 0x52}, // CSI output enabled
	{0x00, AR0234_TABLE_END, 0x00}
};

static struct index_reg_8 ar0231_QuadLink_Ser[] = {
	{0x94, 0x0002, 0x03}, // Disable video transmit for all Pipe (X, Y, Z, U)
	{0x94, 0x0007, 0xF7}, // Set video transmit to parallel mode
			      //
	{0x96, 0x0002, 0x03}, // Disable video transmit for all Pipe (X, Y, Z, U)
	{0x96, 0x0007, 0xF7}, // Set video transmit to parallel mode
			      //
	{0x98, 0x0002, 0x03}, // Disable video transmit for all Pipe (X, Y, Z, U)
	{0x98, 0x0007, 0xF7}, // Set video transmit to parallel mode
			      //
	{0x9A, 0x0002, 0x03}, // Disable video transmit for all Pipe (X, Y, Z, U)
	{0x9A, 0x0007, 0xF7}, // Set video transmit to parallel mode
	
	{0x94, 0x0002, 0x13}, // Enabled video transmit on pipe X  
	{0x96, 0x0002, 0x13}, // Enabled video transmit on pipe X  
	{0x98, 0x0002, 0x13}, // Enabled video transmit on pipe X  
	{0x9A, 0x0002, 0x13}, // Enabled video transmit on pipe X  
	{0x00, AR0234_TABLE_END, 0x00}
};

static struct index_reg_8 ar0231_TripleLink_Ser[] = {
	{0x94, 0x0002, 0x03}, // Disable video transmit for all Pipe (X, Y, Z, U)
	{0x94, 0x0007, 0xF7}, // Set video transmit to parallel mode
			      //
	{0x96, 0x0002, 0x03}, // Disable video transmit for all Pipe (X, Y, Z, U)
...
static struct index_reg_8 ar0231_DualLink_Ser[] = {
	{0x94, 0x0002, 0x03}, // Disable video transmit for all Pipe (X, Y, Z, U)
	{0x94, 0x0007, 0xF7}, // Set video transmit to parallel mode
			      //
	{0x96, 0x0002, 0x03}, // Disable video transmit for all Pipe (X, Y, Z, U)
...
static struct index_reg_8 ar0231_SingleLink_Ser[] = {
	{0x94, 0x0002, 0x03}, // Disable video transmit for all Pipe (X, Y, Z, U)
	{0x94, 0x0007, 0xF7}, // Set video transmit to parallel mode
	{0x94, 0x0002, 0x13}, // Enabled video transmit on pipe X  
	{0x00, AR0234_TABLE_END, 0x00}
...
static struct index_reg_8 Owl_QuadLink_Dser_InFsync[] = {
	...
	{0x9A, 0x02C9, 0x08},
#else
	{0x94, 0x02D3, 0x04}, //MFP7 for FSIN
	{0x94, 0x02D5, 0x08},

	{0x96, 0x02D3, 0x04}, //MFP7 for FSIN
	{0x96, 0x02D5, 0x08},

	{0x98, 0x02D3, 0x04}, //MFP7 for FSIN
	{0x98, 0x02D5, 0x08},

	{0x9A, 0x02D3, 0x04}, //MFP7 for FSIN
	{0x9A, 0x02D5, 0x08},
#endif
	{DES_ADDR, 0x04B1, 0x40}, // FSYNC TX ID is 8
	{0x00, AR0234_TABLE_END, 0x00 }
...
static struct index_reg_8 max96724_colorbar[] = {
	/* DEBUG_EXTRA & PATGEN_CLK_SRC = 75Mhz pclk */
	{DES_ADDR, 0x0009, 0x01}, /* if DEBUG_EXTRA[1:0] = 2b01, PCLK Frequency is 75MHz (don't care PATGEN_CLK_SRC) */
	{DES_ADDR, 0x01dc, 0x00},

	{DES_ADDR, 0x1052, 0x00},		/* vs delay */
	...
	{DES_ADDR, 0x1070, 0x00},
	{DES_ADDR, 0x1071, 0x00},	/* color B */
	{DES_ADDR, 0x1072, 0x00},
	{DES_ADDR, 0x1073, 0xFF},

	{DES_ADDR, 0x1074, 0x50},	/* chkr_rpt_a = 80 */
...
static struct index_reg_8 max9295_colorbar[] = {
	{0x94,0x01E5, 0x02},
	{0x96,0x01E5, 0x02},
	{0x98,0x01E5, 0x02},
	{0x9A,0x01E5, 0x02},
...
enum {
	...
	AR0231_DSER,
	AR0231_QUADLINK_SER,
	AR0231_TRIPLELINK_SER,
	AR0231_DUALLINK_SER,
	AR0231_SINGLELINK_SER,
	AR0234_MODE_TEST_PATTERN,
	MAX96724_MODE_TEST_PATTERN,
	MAX9295_MODE_TEST_PATTERN
};
static struct index_reg_8 *mode_table[] = {
	...
	[AR0231_DSER] = ar0231_Dser,
	[AR0231_QUADLINK_SER] = ar0231_QuadLink_Ser,
	[AR0231_TRIPLELINK_SER] = ar0231_TripleLink_Ser,
	[AR0231_DUALLINK_SER] = ar0231_DualLink_Ser,
	[AR0231_SINGLELINK_SER] = ar0231_SingleLink_Ser,
	[AR0234_MODE_TEST_PATTERN] = tp_colorbars,
	[MAX96724_MODE_TEST_PATTERN] = max96724_colorbar,
	[MAX9295_MODE_TEST_PATTERN] = max9295_colorbar,
};
