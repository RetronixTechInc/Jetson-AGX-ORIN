...
#define MDIO_PMA_PMD_BT1_CTRL	0x834	/* BASE-T1 PMA/PMD control register */
#define MDIO_PCS_1000BT1_CTRL	0x900	/* 1000BASE-T1 PCS control register */
#define MDIO_PCS_1000BT1_STAT	0x901	/* 1000BASE-T1 PCS status register */
